...
namespace MyBlog.src {
    ...
    public class FakeArticleDataProvider : IArticleDataProvider {
        ...
        public ArticleInfo GetArticleById(int id , bool getNext = true) {
            //Note: In a DB, we would want to check for the highest article id *under* this id.
            int actualId;
            if(getNext) { actualId = (id - 1) % _articles.Count(); }
            else { actualId = id; }
        ...
        public void Initialize() {
            ...
            for(int i =0; i <100; ++i) {
                ...
                string content = "<img src=\"https://platekitten.com/400/300\"/>" +
                    "<ul>" +
                    "<li>Some point about something</li>" +
                    "<li><a href='http://packpub.com' target='_blank'>Packt</a></li>" +
                    "</ul>";
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<ArticleInfo> GetArticleIdsAndTitles() { return _articles; }
        ...
        public bool UpdateArticle(int id,string title, string content) { _articles[id] = new ArticleInfo(id, title, content); return true; }

        /// <summary>
        /// Creaqtes a new article.
        /// </summary>
        /// <param name="title">The title</param>
        /// <param name="content">The content</param>
